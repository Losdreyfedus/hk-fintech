package com.hk-fintech.hk.paymentservice.kafka.producer;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.hk-fintech.hk.common.events.kafka.PaymentCompletedEvent;
...
public class PaymentProducer {
    ...
    public void sendTopUpCompletedEvent(com.hk-fintech.hk.common.events.kafka.TopUpCompletedEvent event) {
        try {
            String message = objectMapper.writeValueAsString(event);
